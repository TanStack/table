...
>) {
   ...
   * ```
   */
  function useTableContext<TData extends RowData = RowData>(): ReactTable<TFeatures, TData> {
  ...
  > {
    ...
    const AppCell = useMemo(() => {
      ...
      >(
        ...
        const extendedCell = Object.assign(cell, cellComponents)
    ...
    const AppHeader = useMemo(() => {
      ...
      >(
        ...
        const extendedHeader = Object.assign(header, headerComponents)
