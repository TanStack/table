...
> {
   ...
   */
  getCenterVisibleLeafColumns: () => Array<
   ...
   * @link [Guide](https://tanstack.com/table/v8/docs/guide/column-visibility)
   */
  getLeftVisibleLeafColumns: () => Array<
    Column<TFeatures, TFns, TData, unknown>
  >
  /**
   ...
   * @link [Guide](https://tanstack.com/table/v8/docs/guide/column-visibility)
   */
  getRightVisibleLeafColumns: () => Array<
    Column<TFeatures, TFns, TData, unknown>
  >
  /**
