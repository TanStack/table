...
export interface CachedRowModels<
  ...
  TData extends RowData,
> {
  Core?: () => RowModel<TFeatures, TFns, TData>
  Expanded?: () => RowModel<TFeatures, TFns, TData>
  Filtered?: () => RowModel<TFeatures, TFns, TData>
  Grouped?: () => RowModel<TFeatures, TFns, TData>
  Paginated?: () => RowModel<TFeatures, TFns, TData>
  Sorted?: () => RowModel<TFeatures, TFns, TData>
  FacetedMinMax?: (columnId: string) => [number, number]
  Faceted?: (columnId: string) => RowModel<TFeatures, TFns, TData>
