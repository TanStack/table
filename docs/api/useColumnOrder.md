...
- [Source](https://github.com/tanstack/react-table/tree/master/examples/column-ordering)
- [Open in CodeSandbox](https://codesandbox.io/s/github/tanstack/react-table/tree/master/examples/column-ordering)
