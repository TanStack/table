...
export type SortingFn<TData extends AnyData> = {
  (rowA: Row<TFeatures, TFns, TData>, rowB: Row<TFeatures, TFns, TData>, columnId: string): number
}
```
...
```tsx
getAutoSortingFn: () => SortingFn<TFeatures, TFns, TData>
```
...
```tsx
getSortingFn: () => SortingFn<TFeatures, TFns, TData>
```
...
```tsx
getSortedRowModel?: (table: Table<TFeatures, TFns, TData>) => () => RowModel<TFeatures, TFns, TData>
```
...
```tsx
getPreSortedRowModel: () => RowModel<TFeatures, TFns, TData>
```
...
```tsx
getSortedRowModel: () => RowModel<TFeatures, TFns, TData>
```
