...
To implement client-side sorting, add the `rowSortingFeature` and the `sortedRowModel` factory to your `tableFeatures` call. Import `createSortedRowModel` and the individual sorting functions you use from TanStack Table:
