---
title: Fuzzy Filtering (Octane) Guide
---
...
```typescript
import { metaHelper } from '@tanstack/octane-table'
...
import { sortFn_alphanumeric } from '@tanstack/octane-table'
import type { SortFn } from '@tanstack/octane-table'
