...
Defined in: [createTableHook.tsx:592](https://github.com/TanStack/table/blob/main/packages/preact-table/src/createTableHook.tsx#L592)
...
[`AppPreactTable`](../type-aliases/AppPreactTable.md)\<`TFeatures`, `TData`, `TSelected`, `TTableComponents`, `TCellComponents`, `THeaderComponents`\>
...
```ts
useTableContext: <TData>() => PreactTable<TFeatures, TData>;
```
...
[`PreactTable`](../type-aliases/PreactTable.md)\<`TFeatures`, `TData`\>
