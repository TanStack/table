...
To implement client-side sorting, add the `rowSortingFeature`, `sortedRowModel`, and `sortFns` to your `tableFeatures` call. Import `createSortedRowModel` and the individual sorting functions you use from TanStack Table:
