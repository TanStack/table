...
Defined in: [packages/angular-table/src/helpers/createTableHook.ts:137](https://github.com/TanStack/table/blob/main/packages/angular-table/src/helpers/createTableHook.ts#L137)
