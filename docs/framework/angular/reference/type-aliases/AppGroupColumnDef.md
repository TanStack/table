...
Defined in: [packages/angular-table/src/helpers/createTableHook.ts:138](https://github.com/TanStack/table/blob/main/packages/angular-table/src/helpers/createTableHook.ts#L138)
