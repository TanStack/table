...
Defined in: [packages/svelte-table/src/createTableHook.svelte.ts:140](https://github.com/TanStack/table/blob/main/packages/svelte-table/src/createTableHook.svelte.ts#L140)
