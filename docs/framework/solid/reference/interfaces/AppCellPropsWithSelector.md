...
Defined in: [createTableHook.tsx:320](https://github.com/TanStack/table/blob/main/packages/solid-table/src/createTableHook.tsx#L320)
...
```ts
children: (cell, state) => Element;
```

Defined in: [createTableHook.tsx:321](https://github.com/TanStack/table/blob/main/packages/solid-table/src/createTableHook.tsx#L321)
