...
import type { FilterFn, RowData, TableFeatures } from '@tanstack/solid-table'
...
To reference this filter function by the string name `'fuzzy'` (and to type the stored filter meta), register it in the `filterFns` slot on `tableFeatures` and declare a `filterMeta` slot for the meta type:

```typescript
import { metaHelper } from '@tanstack/solid-table'
import type { FilterFn, RowData, TableFeatures } from '@tanstack/solid-table'
...
import { sortFn_alphanumeric } from '@tanstack/solid-table'
