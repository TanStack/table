---
title: Column Sizing (Ember) Guide
---
...
const columnSizing = columnSizingAtom.get() // read the atom wherever it is needed
...
@tracked columnSizing: ColumnSizingState = {}
