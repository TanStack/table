...
- `default`\<`FlexRenderHeaderSignature`\<`TFeatures`, `TData`, `TValue`\>\>
...
```ts
new FlexRenderHeader<TFeatures, TData, TValue>(owner, args): FlexRenderHeader<TFeatures, TData, TValue>;
```
...
`FlexRenderHeader`\<`TFeatures`, `TData`, `TValue`\>

#### Inherited from

```ts
Component<FlexRenderHeaderSignature<TFeatures, TData, TValue>>.constructor
```
...
```ts
[Context]: ComponentContext<FlexRenderHeader<TFeatures, TData, TValue>, FlexRenderHeaderSignature<TFeatures, TData, TValue>>;
```
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:45
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:44
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:46
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:43
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:42
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:41
