...
- `default`\<`FlexRenderCellSignature`\<`TFeatures`, `TData`, `TValue`\>\>
...
```ts
new FlexRenderCell<TFeatures, TData, TValue>(owner, args): FlexRenderCell<TFeatures, TData, TValue>;
```
...
```ts
Component<FlexRenderCellSignature<TFeatures, TData, TValue>>.constructor
```
...
```ts
[Context]: ComponentContext<FlexRenderCell<TFeatures, TData, TValue>, FlexRenderCellSignature<TFeatures, TData, TValue>>;
```
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:31
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:30
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:32
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:29
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:28
...
Defined in: packages/ember-table/declarations/FlexRender.d.ts:27

##### Returns

`CellRenderResult`\<`TFeatures`, `TData`, `TValue`\>
