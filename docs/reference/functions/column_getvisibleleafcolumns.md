...
```ts
function column_getVisibleLeafColumns<TFeatures, TData>(table, position?): Column<TableFeatures, TData, unknown>[]
```
...
[features/column-visibility/ColumnVisibility.utils.ts:103](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/column-visibility/ColumnVisibility.utils.ts#L103)
