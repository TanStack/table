...
```ts
function table_getSelectedRowModel<TFeatures, TData>(table): RowModel<TableFeatures, TData>
```
...
[features/row-selection/RowSelection.utils.ts:154](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-selection/RowSelection.utils.ts#L154)
