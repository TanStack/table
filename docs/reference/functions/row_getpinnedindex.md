...
```ts
function row_getPinnedIndex<TFeatures, TData>(row, table): number
```
...
[features/row-pinning/RowPinning.utils.ts:242](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-pinning/RowPinning.utils.ts#L242)
