...
```ts
function row_getCanPin<TFeatures, TData>(row, table): boolean
```
...
[features/row-pinning/RowPinning.utils.ts:195](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-pinning/RowPinning.utils.ts#L195)
