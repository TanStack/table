...
```ts
function column_getIsVisible<TFeatures, TData, TValue>(column, table): boolean
```
...
[features/column-visibility/ColumnVisibility.utils.ts:44](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/column-visibility/ColumnVisibility.utils.ts#L44)
