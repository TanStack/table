...
```ts
function column_getCanGlobalFilter<TFeatures, TData, TValue>(column, table): boolean
```
...
[features/global-filtering/GlobalFiltering.utils.ts:25](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/global-filtering/GlobalFiltering.utils.ts#L25)
