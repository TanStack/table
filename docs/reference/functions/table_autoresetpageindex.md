...
```ts
function table_autoResetPageIndex<TFeatures, TData>(
   table, 
   registered, 
   queued): void
```
...
[features/row-pagination/RowPagination.utils.ts:37](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-pagination/RowPagination.utils.ts#L37)
