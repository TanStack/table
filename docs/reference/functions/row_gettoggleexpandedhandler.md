...
```ts
function row_getToggleExpandedHandler<TFeatures, TData>(row, table): () => void
```
...
[features/row-expanding/RowExpanding.utils.ts:399](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-expanding/RowExpanding.utils.ts#L399)
