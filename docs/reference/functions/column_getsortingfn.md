...
```ts
function column_getSortingFn<TFeatures, TData, TValue>(column, table): SortingFn<any, any> | SortingFn<TableFeatures, TData> & SortingFn<TFeatures, TData>
```
...
[`SortingFn`](../interfaces/sortingfn.md)\<`any`, `any`\> \| [`SortingFn`](../interfaces/sortingfn.md)\<[`TableFeatures`](../interfaces/tablefeatures.md), `TData`\> & [`SortingFn`](../interfaces/sortingfn.md)\<`TFeatures`, `TData`\>

## Defined in

[features/row-sorting/RowSorting.utils.ts:137](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-sorting/RowSorting.utils.ts#L137)
