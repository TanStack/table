---
id: table_getPrePaginationRowModel
title: table_getPrePaginationRowModel
---

# Function: table\_getPrePaginationRowModel()

```ts
function table_getPrePaginationRowModel<TFeatures, TData>(table): RowModel<TFeatures, TData>
```
...
[features/row-pagination/RowPagination.utils.ts:350](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-pagination/RowPagination.utils.ts#L350)
