...
```ts
function column_clearSorting<TFeatures, TData, TValue>(column, table): void
```
...
[features/row-sorting/RowSorting.utils.ts:435](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/features/row-sorting/RowSorting.utils.ts#L435)
