...
```ts
optional _createCell: <TFeatures, TData, TValue>(cell, table) => void;
```
...
[types/TableFeatures.ts:12](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L12)
...
```ts
optional _createColumn: <TFeatures, TData, TValue>(column, table) => void;
```
...
[types/TableFeatures.ts:20](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L20)
...
```ts
optional _createHeader: <TFeatures, TData, TValue>(header, table) => void;
```
...
[types/TableFeatures.ts:28](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L28)
...
```ts
optional _createRow: <TFeatures, TData>(row, table) => void;
```
...
[types/TableFeatures.ts:36](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L36)
...
```ts
optional _createTable: <TFeatures, TData>(table) => void;
```
...
[types/TableFeatures.ts:40](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L40)
...
```ts
optional _getDefaultColumnDef: <TFeatures, TData, TValue>() => Partial<ColumnDef<TFeatures, TData, TValue>>;
```
...
`Partial`\<[`ColumnDef`](../type-aliases/columndef.md)\<`TFeatures`, `TData`, `TValue`\>\>

#### Defined in

[types/TableFeatures.ts:43](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L43)
...
```ts
optional _getDefaultOptions: <TFeatures, TData>(table) => Partial<object>;
```
...
• **parent?**: [`Row`](../type-aliases/row.md)\<..., ...\>
...
```ts
optional getSubRows: (originalRow, index) => undefined | ...[];
```
...
```ts
optional mergeOptions: ((defaultOptions: { _features: TableFeatures; _rowModels?: RowModelOptions<TableFeatures, TData> | undefined; autoResetAll?: boolean | undefined; ... 72 more ...; sortingFns?: Record<...> | undefined; }, options: Partial<...>) => { ...; }) | undefined;
```
...
[types/TableFeatures.ts:48](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L48)
...
```ts
optional _getInitialState: <TFeatures>(initialState?) => Partial<object>;
```
...
[types/TableFeatures.ts:51](https://github.com/TanStack/table/blob/b1e6b79157b0debc7222660572b06c8b857f4605/packages/table-core/src/types/TableFeatures.ts#L51)
