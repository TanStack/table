...
Defined in: [types/Table.ts:39](https://github.com/TanStack/table/blob/main/packages/table-core/src/types/Table.ts#L39)
...
[`Table_Table`](Table_Table.md).[`optionsStore`](Table_Table.md#optionsstore)
