...
Defined in: [features/row-sorting/rowSortingFeature.types.ts:275](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-sorting/rowSortingFeature.types.ts#L275)
...
Defined in: [features/row-sorting/rowSortingFeature.types.ts:279](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-sorting/rowSortingFeature.types.ts#L279)
