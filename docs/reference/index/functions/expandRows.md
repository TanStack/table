...
Defined in: [features/row-expanding/createExpandedRowModel.ts:56](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-expanding/createExpandedRowModel.ts#L56)
