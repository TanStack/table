...
- [AggregationFnDef](interfaces/AggregationFnDef.md)
- [AggregationFnDescriptor](interfaces/AggregationFnDescriptor.md)
...
- [Cell\_CellSelection](interfaces/Cell_CellSelection.md)
- [Cell\_CellSpanning](interfaces/Cell_CellSpanning.md)
...
- [Cell\_RowAggregation](interfaces/Cell_RowAggregation.md)
- [CellContext](interfaces/CellContext.md)
- [CellSelectionBounds](interfaces/CellSelectionBounds.md)
- [CellSelectionEdges](interfaces/CellSelectionEdges.md)
- [CellSelectionRange](interfaces/CellSelectionRange.md)
- [CellSpanIndex](interfaces/CellSpanIndex.md)
- [ColSpanContext](interfaces/ColSpanContext.md)
...
- [Column\_Internal](interfaces/Column_Internal.md)
- [Column\_RowAggregation](interfaces/Column_RowAggregation.md)
- [Column\_RowSorting](interfaces/Column_RowSorting.md)
- [ColumnDef\_CellSelection](interfaces/ColumnDef_CellSelection.md)
- [ColumnDef\_CellSpanning](interfaces/ColumnDef_CellSpanning.md)
...
- [ColumnDef\_RowAggregation](interfaces/ColumnDef_RowAggregation.md)
...
- [ColumnIndexes](interfaces/ColumnIndexes.md)
- [ColumnMeta](interfaces/ColumnMeta.md)
- [ColumnOffsets](interfaces/ColumnOffsets.md)
- [ColumnOffsetsByPosition](interfaces/ColumnOffsetsByPosition.md)
...
- [CreatedFilterFn](interfaces/CreatedFilterFn.md)
- [CreatedSortFn](interfaces/CreatedSortFn.md)
- [FeatureSlotPrereqs](interfaces/FeatureSlotPrereqs.md)
- [FilterFn](interfaces/FilterFn.md)
- [FilterFnDef](interfaces/FilterFnDef.md)
...
- [ResolvedAggregationFn](interfaces/ResolvedAggregationFn.md)
...
- [Row\_RowAggregation](interfaces/Row_RowAggregation.md)
...
- [RowModelFns\_All](interfaces/RowModelFns_All.md)
...
- [RowModelFns\_RowAggregation](interfaces/RowModelFns_RowAggregation.md)
...
- [RowSpanContext](interfaces/RowSpanContext.md)
- [SelectCellRangeOptions](interfaces/SelectCellRangeOptions.md)
- [SortFn](interfaces/SortFn.md)
- [SortFnDef](interfaces/SortFnDef.md)
...
- [Table\_CellSelection](interfaces/Table_CellSelection.md)
- [Table\_CellSpanning](interfaces/Table_CellSpanning.md)
...
- [Table\_Internal](interfaces/Table_Internal.md)
...
- [TableOptions\_CellSelection](interfaces/TableOptions_CellSelection.md)
- [TableOptions\_CellSpanning](interfaces/TableOptions_CellSpanning.md)
...
- [TableOptions\_RowAggregation](interfaces/TableOptions_RowAggregation.md)
...
- [TableState\_All](interfaces/TableState_All.md)
- [TableState\_CellSelection](interfaces/TableState_CellSelection.md)
...
- [AggregationFnListItem](type-aliases/AggregationFnListItem.md)
- [AggregationFnOption](type-aliases/AggregationFnOption.md)
- [AggregationFnRef](type-aliases/AggregationFnRef.md)
- [AggregationResult](type-aliases/AggregationResult.md)
- [AggregationResultOf](type-aliases/AggregationResultOf.md)
...
- [TransformDataValueFn](type-aliases/TransformDataValueFn.md)
...
- [aggregationFn\_last](variables/aggregationFn_last.md)
...
- [cellSelectionFeature](variables/cellSelectionFeature.md)
- [cellSpanningFeature](variables/cellSpanningFeature.md)
...
- [filterFn\_between](variables/filterFn_between.md)
- [filterFn\_betweenInclusive](variables/filterFn_betweenInclusive.md)
- [filterFn\_empty](variables/filterFn_empty.md)
- [filterFn\_endsWith](variables/filterFn_endsWith.md)
...
- [filterFn\_inDateRange](variables/filterFn_inDateRange.md)
...
- [filterFn\_notEmpty](variables/filterFn_notEmpty.md)
- [filterFn\_startsWith](variables/filterFn_startsWith.md)
...
- [constructAggregationFn](functions/constructAggregationFn.md)
- [constructCell](functions/constructCell.md)
- [constructColumn](functions/constructColumn.md)
- [constructFilterFn](functions/constructFilterFn.md)
- [constructHeader](functions/constructHeader.md)
- [constructRow](functions/constructRow.md)
- [constructSortFn](functions/constructSortFn.md)
- [constructTable](functions/constructTable.md)
- [copyInstancePropertiesWithoutMemos](functions/copyInstancePropertiesWithoutMemos.md)
...
- [makeObjectMap](functions/makeObjectMap.md)
