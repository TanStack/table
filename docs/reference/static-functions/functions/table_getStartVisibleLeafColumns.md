---
id: table_getStartVisibleLeafColumns
title: table_getStartVisibleLeafColumns
---

# Function: table\_getStartVisibleLeafColumns()

```ts
function table_getStartVisibleLeafColumns<TFeatures, TData>(table): Column_Internal<TFeatures, TData, unknown>[];
```

Defined in: [features/column-pinning/columnPinningFeature.utils.ts:826](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-pinning/columnPinningFeature.utils.ts#L826)
