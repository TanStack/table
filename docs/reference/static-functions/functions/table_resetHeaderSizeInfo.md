...
Defined in: [features/column-resizing/columnResizingFeature.utils.ts:370](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-resizing/columnResizingFeature.utils.ts#L370)
