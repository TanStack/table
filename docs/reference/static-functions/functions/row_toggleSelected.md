...
Defined in: [features/row-selection/rowSelectionFeature.utils.ts:532](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-selection/rowSelectionFeature.utils.ts#L532)
