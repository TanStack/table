...
Defined in: [features/row-sorting/rowSortingFeature.utils.ts:539](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-sorting/rowSortingFeature.utils.ts#L539)
