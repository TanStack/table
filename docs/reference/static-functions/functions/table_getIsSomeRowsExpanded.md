...
Defined in: [features/row-expanding/rowExpandingFeature.utils.ts:189](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/row-expanding/rowExpandingFeature.utils.ts#L189)
