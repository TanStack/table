...
Defined in: [features/column-ordering/columnOrderingFeature.utils.ts:31](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-ordering/columnOrderingFeature.utils.ts#L31)
