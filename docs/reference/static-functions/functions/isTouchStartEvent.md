...
Defined in: [features/column-resizing/columnResizingFeature.utils.ts:361](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-resizing/columnResizingFeature.utils.ts#L361)
