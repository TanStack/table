...
Defined in: [features/column-pinning/columnPinningFeature.utils.ts:674](https://github.com/TanStack/table/blob/main/packages/table-core/src/features/column-pinning/columnPinningFeature.utils.ts#L674)
