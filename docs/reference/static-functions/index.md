...
- [cell\_getCanSelect](functions/cell_getCanSelect.md)
- [cell\_getColSpan](functions/cell_getColSpan.md)
- [cell\_getContext](functions/cell_getContext.md)
- [cell\_getIsAggregated](functions/cell_getIsAggregated.md)
- [cell\_getIsCovered](functions/cell_getIsCovered.md)
- [cell\_getIsFocused](functions/cell_getIsFocused.md)
- [cell\_getIsGrouped](functions/cell_getIsGrouped.md)
- [cell\_getIsPlaceholder](functions/cell_getIsPlaceholder.md)
- [cell\_getIsSelected](functions/cell_getIsSelected.md)
- [cell\_getRowSpan](functions/cell_getRowSpan.md)
- [cell\_getSelectionEdges](functions/cell_getSelectionEdges.md)
- [cell\_getSelectionExtendHandler](functions/cell_getSelectionExtendHandler.md)
- [cell\_getSelectionStartHandler](functions/cell_getSelectionStartHandler.md)
- [cell\_getTabIndex](functions/cell_getTabIndex.md)
...
- [column\_getCanSpan](functions/column_getCanSpan.md)
...
- [getDefaultCellSelectionState](functions/getDefaultCellSelectionState.md)
...
- [row\_getDisplayIndex](functions/row_getDisplayIndex.md)
- [row\_getEndVisibleCells](functions/row_getEndVisibleCells.md)
...
- [row\_getStartVisibleCells](functions/row_getStartVisibleCells.md)
...
- [table\_getCellSelectionBounds](functions/table_getCellSelectionBounds.md)
- [table\_getCellSelectionColumnIds](functions/table_getCellSelectionColumnIds.md)
- [table\_getCellSelectionColumnIndexes](functions/table_getCellSelectionColumnIndexes.md)
- [table\_getCellSelectionMergeBounds](functions/table_getCellSelectionMergeBounds.md)
- [table\_getCellSelectionRowIds](functions/table_getCellSelectionRowIds.md)
- [table\_getCellSpanIndex](functions/table_getCellSpanIndex.md)
...
- [table\_getColumnIndexes](functions/table_getColumnIndexes.md)
- [table\_getColumnOffsets](functions/table_getColumnOffsets.md)
...
- [table\_getEndFlatHeaders](functions/table_getEndFlatHeaders.md)
- [table\_getEndFooterGroups](functions/table_getEndFooterGroups.md)
- [table\_getEndHeaderGroups](functions/table_getEndHeaderGroups.md)
- [table\_getEndLeafColumns](functions/table_getEndLeafColumns.md)
- [table\_getEndLeafHeaders](functions/table_getEndLeafHeaders.md)
- [table\_getEndTotalSize](functions/table_getEndTotalSize.md)
- [table\_getEndVisibleLeafColumns](functions/table_getEndVisibleLeafColumns.md)
...
- [table\_getFocusedCell](functions/table_getFocusedCell.md)
...
- [table\_getRowsInDisplayOrder](functions/table_getRowsInDisplayOrder.md)
- [table\_getSelectedCellCount](functions/table_getSelectedCellCount.md)
- [table\_getSelectedCellIds](functions/table_getSelectedCellIds.md)
- [table\_getSelectedCellRangesData](functions/table_getSelectedCellRangesData.md)
...
- [table\_getStartFlatHeaders](functions/table_getStartFlatHeaders.md)
- [table\_getStartFooterGroups](functions/table_getStartFooterGroups.md)
- [table\_getStartHeaderGroups](functions/table_getStartHeaderGroups.md)
- [table\_getStartLeafColumns](functions/table_getStartLeafColumns.md)
- [table\_getStartLeafHeaders](functions/table_getStartLeafHeaders.md)
- [table\_getStartTotalSize](functions/table_getStartTotalSize.md)
- [table\_getStartVisibleLeafColumns](functions/table_getStartVisibleLeafColumns.md)
...
- [table\_selectAllCells](functions/table_selectAllCells.md)
- [table\_selectCellRange](functions/table_selectCellRange.md)
- [table\_setCellSelection](functions/table_setCellSelection.md)
...
- [table\_setFocusedCell](functions/table_setFocusedCell.md)
