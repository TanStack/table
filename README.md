...
```javascript
{
  ...
  getTheadGroupProps: () => ({ className: '' }),
  getTheadGroupTrProps: () => ({ className: '' }),,
  getTheadGroupThProps: () => ({ className: '' }),,
  getTheadProps: () => ({ className: '' }),,
  getTheadTrProps: () => ({ className: '' }),,
  getTheadThProps: () => ({ className: '' }),,
  getTheadFilterProps: () => ({ className: '' }),,
  getTheadFilterTrProps: () => ({ className: '' }),,
  getTheadFilterThProps: () => ({ className: '' }),,
  getTbodyProps: () => ({ className: '' }),,
  getTrGroupProps: () => ({ className: '' }),,
  getTrProps: () => ({ className: '' }),,
  getThProps: () => ({ className: '' }),,
  getTdProps: () => ({ className: '' }),,
  getTfootProps: () => ({ className: '' }),,
  getTfootTrProps: () => ({ className: '' }),,
  getTfootThProps: () => ({ className: '' }),,
  getPaginationProps: () => ({ className: '' }),,
  getLoadingProps: () => ({ className: '' }),,
  getNoDataProps: () => ({ className: '' }),,
  getResizerProps: () => ({ className: '' }),,
