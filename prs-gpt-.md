...
Generated 2026-07-30, updated 2026-08-01 and again 2026-08-02 to remove closed entries. This audit now contains **70** pull requests that remain open in [`TanStack/table`](https://github.com/TanStack/table/pulls); it does not add PRs opened after the original scan.
...
### Resolved or Superseded in V9 (2)

- [#5823 — fix: crash when ungrouping after aggregation row was pinned](https://github.com/TanStack/table/pull/5823) — Superseded: [#5822](https://github.com/TanStack/table/issues/5822) was fixed on `beta` by [#6493](https://github.com/TanStack/table/pull/6493) (merged 2026-08) and the issue is closed; nothing left to port from this v8 branch.
- [#6177 — fix: table-core's getIsAllSubRowsSelected returns false when subrows are unselectable](https://github.com/TanStack/table/pull/6177) — Superseded: [#5173](https://github.com/TanStack/table/issues/5173) was fixed on `beta` by [#6491](https://github.com/TanStack/table/pull/6491) and the issue is closed; sibling v8 PR #5790 was already closed.

### Revisit with a Fresh V9 PR (11)
...
- [#5274 — Do not select subrows if enableSubRowSelection is false](https://github.com/TanStack/table/pull/5274) — Stale v8 patch; the goal is now accepted and implemented on beta (2026-08-02, per #5116): select-all and the all-selected getters honor `enableSubRowSelection` via a shared eligibility rule. Close as superseded by the beta implementation rather than porting this diff.
...
### Too Conflict-heavy to Rescue (1)
