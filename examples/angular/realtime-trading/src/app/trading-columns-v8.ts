import { flexRenderComponent } from '@tanstack/angular-table-v8'
import {
  DepthCell,
  DownMoveCell,
  PriceCell,
...
import type { ColumnDef } from '@tanstack/angular-table-v8'
...
export function createV8TradingColumns(
  state: TradingColumnState,
): Array<ColumnDef<MarketQuote>> {
  return [
    {
      id: 'symbol',
      header: 'Ticker',
