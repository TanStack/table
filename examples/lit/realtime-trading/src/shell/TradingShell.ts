...
export class TradingShell extends ControllerElement {
  ...
  protected render() {
    return html`<main
      class="trading-terminal ${this.sidebarOpen ? '' : 'is-sidebar-collapsed'}"
    >
      ...
      <trading-market-statusbar
        .controller=${this.controller}
      ></trading-market-statusbar>
      <div class="sidebar-slot">
        ${this.sidebarOpen ? html`<trading-configurator .controller=${this.controller} .feed=${this.feed}></trading-configurator>` : null}
      </div>
    </main>`
  }
}
