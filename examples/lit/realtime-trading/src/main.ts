...
export class RealtimeTradingApp extends LitElement {
  ...
  readonly #stop = { feed: null as (() => void) | null, benchmark: null as (() => void) | null }
  ...
  disconnectedCallback() {
    this.#stop.benchmark?.(); this.#stop.feed?.()
    super.disconnectedCallback()
  }
  protected render() { return html`<trading-shell .controller=${this.#benchmark} .feed=${this.#feed}></trading-shell>` }
}
