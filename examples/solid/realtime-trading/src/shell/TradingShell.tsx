...
function MarketStatusbar() {
  ...
  return (
    <footer class="market-statusbar">
      ...
      <span>
        CHANGED ROWS <strong>{formatInteger(metrics().lastUpdateCount)}</strong>
      </span>
      <span>
        ...
        <Show
          ...
          fallback={
            <>
              ...
              <small>unsupported by this browser</small>
            </>
          }
        >
          <strong
